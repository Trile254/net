...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        // lưu thêm type object vào file json để khi load file lên, ta biết được object nào là Dog, Cat
        ...
        // Root cause:
        // Lỗi vì khi load file lên thì các object trong list animals1 không phải là Dog hoặc Cat, mà là Animal

         // Solution
        // Để fix lỗi này, ta cần lưu type của object vào file json
        // để khi load file lên, ta biết được object nào là Dog, class nào là Cat. Thư viện Newtonsoft.Json sẽ giúp mình làm việc này
